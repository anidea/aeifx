...
// NOTE: Alternatively, you can aign a fixed IP to configure your
//       Ethernet shield.
...
//       Ethernet.begin(mac, ip);   
  ...
  Serial.println(mdns.begin(Ethernet.localIP(), "arduino"));
  ...
  Serial.println(mdns.addServiceRecord("_test",
                        80,
                        MDNSServiceTCP));
}
